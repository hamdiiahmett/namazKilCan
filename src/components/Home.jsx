  ...
  return (
    <div className="flex flex-col h-full w-full max-w-[500px] mx-auto overflow-y-auto px-4 py-4 space-y-6 pb-24">
      ...
      <div className="text-center space-y-1 mt-2">
        ...
        <p className="text-sm font-medium text-slate-500">Ametcan &amp; Zenepcan</p>
      </div>
          ...
          >
            ...
            {canDelete(latestImage) && (
              <button
                ...
                className="absolute top-3 left-3 bg-black/50 hover:bg-red-500/80 text-white p-1.5 rounded-full backdrop-blur-md transition-colors opacity-0 group-hover:opacity-100 z-10"
                title="Resmi Sil"
              >
                <Trash2 size={14} />
              </button>
              ...
              >
                ...
                {canDelete(img) && (
                  <button
                    ...
                    className="absolute top-1.5 right-1.5 bg-black/50 hover:bg-red-500 text-white p-1 rounded-full backdrop-blur-md transition-all opacity-0 group-hover:opacity-100 shadow-md z-10 active:scale-90"
                    title="Resmi Sil"
                  >
                    <Trash2 size={12} />
                  </button>
        ...
        >
          ...
          {canDelete(images[lightboxIndex]) && (
            <button
              ...
              className="absolute top-6 left-6 text-white p-2 bg-black/40 hover:bg-red-500/80 rounded-full backdrop-blur-md transition-colors z-50"
              title="Resmi Sil"
            >
              <Trash2 size={20} />
            </button>
